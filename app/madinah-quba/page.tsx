export const metadata = {
  title: "مأذون شرعي حي قباء المدينة المنورة | عقد نكاح سريع",
  description:
    "مأذون شرعي في حي العوالي بالمدينة المنورة لتوثيق عقود الزواج بسرعة وخدمة جميع الأحياء.",
};
    ...
    <>
      ...
      <div className="wrapper">
        <div className="content-card">
          ...
          <div className="phone-display">📞 0554659799</div>
